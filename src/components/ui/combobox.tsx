    ...
    return (
      <InputGroup className={cn("w-auto", className)}>
        <ComboboxPrimitive.Input
          {...props}
          ref={ref}
          // En lugar de pasar el elemento directamente, pasa una función
          render={(inputProps) => (
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 z-100",
        className,
      )}
      {...props}
    >
...
function ComboboxGroup({ className, ...props }: ComboboxPrimitive.Group.Props) {
  return (
    <ComboboxPrimitive.Group
      data-slot="combobox-group z-100"
      className={cn(className)}
      {...props}
    />
  );
